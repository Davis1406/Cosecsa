                                    ...
                                    <tbody>
                                        @foreach ($getRecord as $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-info btn-sm" style="margin-right: 5px" href="{{ url('examiner/view_results/'.$value->candidate_id) }}">View</a>
                                                        <a class="btn btn-warning btn-sm" href="{{url('examiner/resubmit/' .$value->candidate_id)}}">Resubmit</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
