                    ...
                    <div class="col-md-4">
                        <div class="card fee-card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#addFeeTypeModal">
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.fees.types.store') }}">
                ...
                <div class="modal-header" style="border-bottom:2px solid #a02626;">
                    <h5 class="modal-title" style="color:#a02626;">Add Fee Type</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Group <span class="text-danger">*</span></label>
                        <input type="text" name="fee_group" class="form-control" list="feeGroupList" required placeholder="e.g. Annual Subscription">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            <label class="custom-control-label" for="addAppliesSub">Routes into a fellow's Annual Subscription record</label>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn font-weight-bold" style="background:#a02626;border-color:#a02626;color:#fff;">Create</button>
                </div>
            </form>
        </div>
    </div>
