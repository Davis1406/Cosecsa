...
use App\Http\Controllers\DraftEmailsController;
...
Route::group(['middleware' => ['admin', 'permission']], function(){
    ...
    Route::get('admin/draft-emails', [DraftEmailsController::class,'list']);
    Route::get('admin/draft-emails/add', [DraftEmailsController::class,'add']);
    Route::post('admin/draft-emails/add', [DraftEmailsController::class,'insert']);
    Route::get('admin/draft-emails/edit/{id}', [DraftEmailsController::class,'edit']);
    Route::post('admin/draft-emails/edit/{id}', [DraftEmailsController::class,'update']);
...
Route::post('admin/exams/test_results/{specialty}/{id}/destroy', [ExamsController::class, 'destroyTestResult'])->name('test_results.destroy.record');
Route::post('admin/exams/test_results/destroy', [ExamsController::class, 'destroyAllTestResults'])->name('test_results.destroy.all');
