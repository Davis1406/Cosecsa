...
<div style="width:100%; background:#f4f4f4; padding:24px 0;">
  <div style="max-width:620px; margin:0 auto; background:#ffffff; border-radius:6px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,.08);">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding:18px 28px; vertical-align:middle; width:76px;">
            <img src="https://cosecsamis.org/public/dist/img/Cosecsa_Logo.png" alt="COSECSA" width="60" height="60" style="display:block; border:0;">
          </td>
    ...
    <div style="background:#f9f9f9; border-top:1px solid #e8e8e8; padding:20px 32px;">
      <p style="margin:0; font-size:11.5px; color:#888; line-height:1.6;">
      ...
      <p style="margin:10px 0 0; font-size:10.5px; color:#aaa;">
        This email was sent from the COSECSA Management Information System, with your letter attached as a PDF.
      </p>
    </div>
