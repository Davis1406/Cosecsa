                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center flex-wrap" style="gap:.5rem;">
                                <h3 class="card-title mb-0">GS Results — {{ $selectedYearName }}</h3>
                                <form method="GET" action="{{ url('admin/exams/gs_results') }}" class="d-flex align-items-center flex-shrink-0" style="gap:.4rem;">
