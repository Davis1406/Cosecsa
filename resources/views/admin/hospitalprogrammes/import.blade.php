            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Import Hospital Programmes</h1>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                </section>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header" style="background-color: darkred">
                                        <h3 class="card-title">Upload Hospital Programmes (CSV/XLS/XLSX):</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <div class="col-md-6 offset-md-3">

                                        <form method="POST" action="{{ route('hospitalprogrammes.import.data') }}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="card-body">
