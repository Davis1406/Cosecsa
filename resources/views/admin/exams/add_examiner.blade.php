        ...
        <section class="content">
            <div class="container-fluid">
                <div class="form-container">
                    ...
                    <form id="examinerForm" method="POST" action="{{ route('examiners.add') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label for="passport_upload" class="custom-file-upload">
                                                <i class="fas fa-cloud-upload-alt"></i>
                                                <span id="passportLabel">Upload Profile Image (JPG/PNG)</span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label for="cv_upload" class="custom-file-upload">
                                                ...
                                                <span id="cvLabel">Upload CV (PDF/DOC)</span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subspecialty" id="subspecialty"
                                                class="form-control" value="{{ old('subspecialty') }}">
                                ...
                                <div class="row">
                                        ...
                                        <div class="checkbox-group exam-availability-group">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    {{ (is_array(old('exam_availability')) && in_array('MCS', old('exam_availability'))) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    {{ (is_array(old('exam_availability')) && in_array('FCS', old('exam_availability'))) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <select name="shift" class="form-control">
                                            <option value="" {{ !old('shift') ? 'selected' : '' }}>Select Shift...</option>
                                            <option value="1" {{ old('shift') == '1' ? 'selected' : '' }}>Morning</option>
                                            <option value="2" {{ old('shift') == '2' ? 'selected' : '' }}>Morning & Afternoon</option>
                                            <option value="3" {{ old('shift') == '3' ? 'selected' : '' }}>Afternoon</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" id="submitBtn" class="btn btn-custom btn-primary-custom"
                                style="display: none;">
                                <i class="fas fa-save"></i> Add Examiner
                            </button>
                        </div>
                    </form>
                </div>
