...
<title>Consolidated Secretariat Report — {{ $periodMonthFormatted }}</title>
</head>
...
<div style="width:100%; background:#f4f4f4; padding:24px 0;">
  <div style="max-width:620px; margin:0 auto; background:#ffffff; border-radius:6px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,.08);">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding:18px 28px; vertical-align:middle; width:76px;">
            <img src="{{ url('dist/img/Cosecsa_Logo_email.png') }}" alt="COSECSA" width="60" height="60" style="display:block; border:0;">
          </td>
    ...
    <div style="padding:32px 32px 24px; color:#2d2d2d; font-size:15px; line-height:1.7;">
      <p style="margin:0 0 14px;">Dear CEO,</p>
      <p style="margin:0 0 14px;">
        The consolidated Secretariat Monthly Report for <strong>{{ $periodMonthFormatted }}</strong>
        is ready for your review. The formatted Word document is attached to this email, and a
        copy has also been sent to you via Messages on the COSECSA MIS.
      </p>
