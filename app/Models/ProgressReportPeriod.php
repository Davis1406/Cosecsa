...
{
    protected $fillable = ['period_month', 'due_date', 'status', 'reminder_sent_at', 'consolidated_at', 'consolidated_by', 'created_by'];
    protected $casts = ['period_month' => 'date', 'due_date' => 'date', 'reminder_sent_at' => 'datetime', 'consolidated_at' => 'datetime'];
